...
//#region node_modules/.nitro/vite/services/ssr/assets/tailor.functions-DX5DECN1.js
/**
...
var analyzeMatch = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => inputSchema.parse(d)).handler(analyzeMatch_createServerFn_handler, async ({ data, context }) => {
...
var extractKeywords = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => inputSchema.parse(d)).handler(extractKeywords_createServerFn_handler, async ({ data, context }) => {
...
var generateCoverLetter = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => letterInputSchema.parse(d)).handler(generateCoverLetter_createServerFn_handler, async ({ data, context }) => {
