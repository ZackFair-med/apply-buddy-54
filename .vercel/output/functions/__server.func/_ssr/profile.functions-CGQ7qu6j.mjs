...
//#region node_modules/.nitro/vite/services/ssr/assets/profile.functions-CGQ7qu6j.js
...
var updateProfile = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => updateSchema.parse(d)).handler(createSsrRpc("d94d0b5402d88327ffc5615e3b5d2a6f5e7a519b2121a922cbe6da824cc59c6d"));
