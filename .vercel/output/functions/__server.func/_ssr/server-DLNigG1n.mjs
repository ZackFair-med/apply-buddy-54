...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DCLe_ORn.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C5OnAFwr.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-__KML2Vz.mjs"),
		import("./start-BecaRyyN.mjs"),
