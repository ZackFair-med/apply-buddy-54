...
//#region node_modules/.nitro/vite/services/ssr/assets/cvs.functions-DF-LRpyg.js
...
var uploadCv = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => uploadSchema.parse(d)).handler(uploadCv_createServerFn_handler, async ({ data, context }) => {
...
var deleteCv = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => objectType({ id: stringType().uuid() }).parse(d)).handler(deleteCv_createServerFn_handler, async ({ data, context }) => {
...
var updateCv = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => updateSchema.parse(d)).handler(updateCv_createServerFn_handler, async ({ data, context }) => {
...
var downloadCv = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => objectType({ id: stringType().uuid() }).parse(d)).handler(downloadCv_createServerFn_handler, async ({ data, context }) => {
