...
//#region node_modules/.nitro/vite/services/ssr/assets/profile.functions-9-6OWgw4.js
...
var updateProfile = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((d) => updateSchema.parse(d)).handler(updateProfile_createServerFn_handler, async ({ data, context }) => {
	const patch = {};
